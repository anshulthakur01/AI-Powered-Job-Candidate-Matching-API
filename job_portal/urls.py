...
from .views import JobListCreateView, JobApplicationListCreatetView, JobRetrieveUpdateDestroyView, RecommendedJobsView

urlpatterns = [
    path('jobs', JobListCreateView.as_view(), name='job_list_create'),
    path('job-applications', JobApplicationListCreatetView.as_view(), name='job_application_list_create'),
